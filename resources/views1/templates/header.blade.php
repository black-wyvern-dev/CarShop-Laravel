...
<section id="top-bar">
    <div class="container">
        ...
        <div class="col-6">
            ...
            @if(Auth::check())
                <!-- Collapse button -->
                <button class="navbar-toggler toggler-example userBttn" type="button" data-toggle="collapse" data-target="#userMobileContent2"
                        aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation">{{Auth::user()->firstName}}</button>
            @endif
        </div>
...
<section class="container" style = "display:flex; align-items:center; flex-direction : row-reverse; justify-content : space-between">
    <!-- Collapsible content -->
    <div class="collapse navbar-collapse" id="userMobileContent1">
    ...
    <style scoped>
     ...
     <div id="navigation-wrapper" class="d-none d-sm-block two_third last" style = "padding-top : 0px;">
        <div class="menu-menu-container"><ul id="menu-menu-1" class="sf-menu sf-js-enabled sf-arrows">
