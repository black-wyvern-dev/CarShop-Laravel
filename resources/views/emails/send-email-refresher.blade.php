...
<table class="body-wrap" style="font-size: 100%; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; width: 100% !important; height: 100%; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; background: #efefef; margin: 0; padding: 0;" bgcolor="#efefef"><tr style="font-size: 100%; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; margin: 0; padding: 0;"><td class="container" style="font-size: 100%; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; display: block !important; clear: both !important; max-width: 580px !important; margin: 0 auto; padding: 0;">
            ...
            <table style="font-size: 100%; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; width: 100% !important; border-collapse: collapse; margin: 0; padding: 0;">
                ...
                <tr style="font-size: 100%; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; margin: 0; padding: 0;"  align="center" >
                    <td class="content" style="font-size: 100%; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; background: white; margin: 0; padding: 30px 35px;" bgcolor="white">
                        ...
                        <p style="font-size: 17px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                            Your advert has been placed on the homepage again!<br>
                            Is this car still for sale and are the details up-to-date?
                        </p>
                    	<p style="font-size: 17px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                            If not, please login in and alter or delete the advert.
                        </p>
                        <p style="font-size: 12px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                            (You can log in with your email address and press "Forgot your password")
                        </p>

                    	<p style="font-size: 17px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                            <a href = "{{$emailData['link_url']}}">{{$emailData['link_url']}}</a>
                        </p>

                        @if ($emailData['user_type'] == 0)
                        	<p style="font-size: 17px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                                Why not advertise your complete stock with us?<br>
                                Please contact us by phone or email for a tailormade quotation!
                            </p>
                        	<p style="font-size: 17px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                                Your adverts will be seen on our websites in <br>
                                The United Kingdom, USA, Holland, Belgium, Germany,<br>
                                France, Spain, Italy, Switzerland, Austria,<br>
                                Poland, Russia, India, New-Zealand and more
                            </p>
                        @endif
                        ...
                        <p style="font-size: 15px; font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65; font-weight: normal; margin: 0 0 20px; padding: 0;">
                            The Oldandyoungtimer and Classics24 team.
                        </p>

                        <a href="https://www.oldandyoungtimer.com/">
                            <img src="https://i.ibb.co/hdF9j3H/imgpsh-fullsize-anim.jpg" alt="Logo-Old-And-Young" border="0" style="max-width:350px; max-height : 100px">
                        </a>
