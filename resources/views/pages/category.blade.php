...
@section('content')
    ...
    <div class="wrapper home container" style=" border:0px solid green; margin-top:20px">
    ...
    <!-- <div id="page-wrapper" class="wrapper category">
        <div class="row">
            <div class="col-lg-9 text-white" style="margin-top: 20px;margin-bottom: 20px;padding: 0px;margin-left: auto; margin-right: auto;"> -->
                @if($type == 'Car')
