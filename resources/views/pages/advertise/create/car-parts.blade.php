                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="odometerType" id="milesCheck" value="miles">
                                <label class="form-check-label" for="odometerType">{{ __('miles') }}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="odometerType" id="kmsCheck" value="kms">
                                <label class="form-check-label" for="odometerType">{{ __('kms') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
